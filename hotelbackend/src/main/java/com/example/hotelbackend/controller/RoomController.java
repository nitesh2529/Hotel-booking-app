...
// import com.example.hotelbackend.exception.PhotoRetrievalException;
...
//     public ResponseEntity<Optional<RoomResponse>> getRoomById(@PathVariable String roomId) {
...
//                         booking.getCheckOutDate(), booking.getBookingConfirmationCode(), null, 0, 0, 0, null, null))
//                 .toList();
...
//     private List<BookedRoom> getAllBookingsByRoomId(String roomId) {
